# Manual setup and small editor exercises

**Fallback/reference route.** The [main README](../README.md) now installs the kit as a plugin
through Claude Code in VS Code and lets Claude prepare the practice workspace. Use the copy
procedure below only if plugin installation is unavailable or if your workplace requires it.
Do not install both copies by default. Steps 6-10 remain optional editor exercises.
